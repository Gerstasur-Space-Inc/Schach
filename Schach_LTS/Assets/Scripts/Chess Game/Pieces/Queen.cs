...
{
    private Vector2Int[] directions = new Vector2Int[] //Richtungen in die sich eine Dame bewegen kann
     {
        Vector2Int.left,
        Vector2Int.up,
        Vector2Int.right,
    ...
    public override List<Vector2Int> SelectAvaliableSquares() //Methode um alle freien Felder in einer Liste zu erfassen
    {
        ...
        float range = Board.BOARD_SIZE;//Wie weit kann eine Dame maximal ziehen
